/**
 * M20 error helpers. The kernel has no 400 constructor, so validation errors use the repository's
 * `.../problems/validation` type (mirrors m06/m07/m15/m19). Details never echo monetary amounts, balances or
 * secrets — payloads carry reference/config data only.
 */
