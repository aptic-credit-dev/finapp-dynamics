/**
 * M12 error helpers. The kernel has no 400 constructor, so validation errors use the repository's
 * `.../problems/validation` type (mirrors m06/m07/m08/m09). Details never echo customer contacts, full
 * narratives, or confidential internal responses.
 */
