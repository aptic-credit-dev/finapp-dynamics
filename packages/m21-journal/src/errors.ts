/**
 * M21 error helpers. The kernel has no 400 constructor, so validation errors use the repository's
 * `.../problems/validation` type (mirrors m06/m07/m15/m19/m20). Details never echo monetary amounts, balances,
 * account numbers or secrets — payloads carry reference/reason data only.
 */
