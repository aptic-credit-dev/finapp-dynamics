 ...
 */
export type DomainEvent = TenantLifecycleEvent | IdentityLifecycleEvent;

/** Every family currently declared. Kept in step with the union; asserted by the contracts smoke suite. */
export const DOMAIN_EVENT_FAMILIES: readonly string[] = [TENANT_LIFECYCLE_FAMILY, IDENTITY_LIFECYCLE_FAMILY];
