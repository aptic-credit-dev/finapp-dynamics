...
const PERSONAS = [
  {
    ...
    perms: [
      ...
      // documents (read/list + attempt download; governance read)
      'documents.document.read',
      'documents.document.download',
      'documents.type.read',
      'documents.retention.read',
      'documents.access.read',
      'documents.legal_hold.read',
      'documents.disposition.read',
    ],
  },
  {
    k: 'd',
  ...
  // --- M09 Documents (base 0d) ---
  {
    k: '1',
    base: '0d',
    login: 'stg_doc_user',
    name: 'Document User (synthetic)',
    code: 'doc_user',
    risk: 'normal',
    perms: [
      'documents.document.read',
  ...
  },
  {
    k: '2',
    base: '0d',
    login: 'stg_doc_manager',
    name: 'Document Manager (synthetic)',
    code: 'doc_manager',
    risk: 'critical',
    perms: [
      'documents.document.read',
      ...
      'documents.document.upload_version',
      'documents.document.activate',
      ...
      'documents.access.revoke',
      'documents.relationship.manage',
      'documents.legal_hold.read',
      'documents.legal_hold.manage',
      'documents.disposition.read',
      'documents.disposition.request',
    ],
  },
  {
    k: '3',
    base: '0d',
    login: 'stg_disposition_approver',
    name: 'Records / Disposition Approver (synthetic)',
    code: 'disposition_approver',
    risk: 'critical',
    perms: [
      'documents.document.read',
      'documents.disposition.read',
  ...
  // --- M19 Finance Configuration personas (base 0f) --------------------------------------------
  // M19 has NO maker-checker anywhere (every mutation is a single .manage/.create/.activate etc.; config has a
  // manage/publish split that is NOT an enforced author≠approver). So — like M12 setup — we do NOT fabricate a
  // distinct author/reviewer pair. One Finance Config Manager drives all master-data lifecycle; a Finance User
  // reads master data + creates journal drafts (selectors); a read-only Auditor; a Restricted proves fail-closed.
  {
    k: '1',
    base: '0f',
    login: 'stg_finance_config_manager',
    name: 'Finance Config Manager — entities/chart/currencies/fiscal/config (synthetic)',
    code: 'finance_config_manager',
    risk: 'critical',
    perms: [
      'finance.entity.read',
      'finance.entity.manage',
      'finance.entity.activate',
      'finance.entity.deactivate',
      'finance.account_type.read',
      'finance.account_type.manage',
      'finance.account.read',
      ...
      'finance.entity_currency.read',
      'finance.entity_currency.manage',
      'finance.fiscal_year.read',
      'finance.fiscal_year.manage',
      'finance.fiscal_year.close',
      'finance.fiscal_year.reopen',
      'finance.period.read',
  ...
  },
  {
    k: '2',
    base: '0f',
    login: 'stg_finance_user',
    name: 'Finance User — reads finance master data, creates journal drafts (synthetic)',
    code: 'finance_user',
    risk: 'elevated',
    perms: [
      'finance.entity.read',
  ...
  },
  {
    k: '3',
    base: '0f',
    login: 'stg_finance_auditor',
    name: 'Finance Auditor — read-only finance master data (synthetic)',
  ...
  },
  {
    k: '4',
    base: '0f',
    login: 'stg_finance_restricted',
    name: 'Finance Restricted — no finance access, proves fail-closed (synthetic)',
