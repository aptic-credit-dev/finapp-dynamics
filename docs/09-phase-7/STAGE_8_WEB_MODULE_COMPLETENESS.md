...
- **WEB READY WITH LIMITATION**: m19-finance, m39-saas, m41-security, m13-case, m14-legal, **m16-litigation** (6).
- **NOT WEB READY (genuine gaps)**: m08-notify, m09-docs, m12-feedback, m18-legaldocs, m28-executive-ai,
  m32-analytics (6).
